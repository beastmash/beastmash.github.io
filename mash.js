...
function genRands() {
	moAni = Math.floor(Math.random() * bList.length);
	diAni = Math.floor(Math.random() * bList.length);
}

function pushNames() {
	genRands();

	document.getElementById("moLabel").innerHTML = bList[moAni];
	document.getElementById("diLabel").innerHTML = bList[diAni];

	document.getElementById("moLink").href = "https://google.com/search?q=" + encodeURIComponent(bList[moAni]);
	document.getElementById("diLink").href = "https://google.com/search?q=" + encodeURIComponent(bList[diAni]);
